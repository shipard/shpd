...
export default {
  ...
  'setup.vatDialog.reportPeriod': 'Control statement frequency',
  ...
  'setup.offer.items.description': 'A short set of items for booking bank fees, interest, FX differences and rounding directly from a document row. Accounts match the selected chart of accounts.',
