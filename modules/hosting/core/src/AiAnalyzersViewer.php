...
/**
 * Hosting — AI analyzery (hosting_core_ai_analyzers). Settings viewer,
 * tabulka je adminOnly — přístup hlídá TableAccessGuard.
 */
class AiAnalyzersViewer extends TableViewer
{
    ...
    {
        $sql = 'SELECT `id`, `name`, `api_key_prefix`, `last_seen`, `docState`, `docStateMain`'
            . ' FROM `' . $this->table . '`';
    ...
    public function renderDetail(int $recordId): array
    {
        ...
        return [
            'tabs' => [[
                ...
                'content' => [
                    'type'   => 'properties',
                    'groups' => [['title' => $isCs ? 'AI analyzer' : 'AI analyzer', 'items' => $items]],
                ],
            ]],
        ];
    }
