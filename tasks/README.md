...
Celkem 178 tasků: **naplánováno** 6 · **částečně** 1 · **hotovo** 171.
...
| `hosting-01-module-skeleton-portal.md` | naplánováno | prerekvizita `hosting-00-admin-only-tables.md` (flag `adminOnly`) splněna |
