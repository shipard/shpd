...
| `structured-fields.md` | částečně | implementace kompletní (6 commitů 2026-09-10: jádro schématu, zápisová autorita v TableGateway, formulář + detail, profil podatele na registraci DPH, odmítnutí zápisu přes generické CRUD, dokumentace); E2E na dev DS 4l3j prošlo (ds-upgrade, uložení formulářem, field-level chyby, detail vieweru). Zbývá ruční proklik UI v prohlížeči a nasazení na alfu. |
