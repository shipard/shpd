...
use Shipard\Module\Economy\Codebooks\CostCenterDocument;

class CostCenterDocumentTest extends TestCase
{
    private function doc(): CostCenterDocument
    {
        return new CostCenterDocument();
    }
    ...
    public function testBeforeSaveTrimsCodeAndName(): void
    {
        ...
        $this->assertSame('VYR', $data['code']);
        $this->assertSame('Výroba', $data['name']);
    }
}
